...
extern void __vdso_nop_entry(void);
...
int main(void) {
    ...
    sym = dlsym(h, "__vdso_nop_entry");
    printf("via dlsym:    __vdso_nop_entry = %p\n", sym);
    ...
    printf("via direct print: __vdso_nop_entry = %p\n", (void *)__vdso_nop_entry);
